...
void loop() {
  ...
  // attempting to read immediately causes funky voltages so we will wait for 1 second
  // before we poll the analog pin
  delay(3000);
  ...
  // particle build console
  Particle.publish("SoilVolts", String(SMVolts));
